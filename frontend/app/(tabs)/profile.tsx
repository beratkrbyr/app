...
const styles = StyleSheet.create({
  ...
  notAuthContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 32, backgroundColor: '#0f172a' },
  notAuthTitle: { fontSize: 24, fontWeight: 'bold', color: '#ffffff', marginTop: 24, marginBottom: 12 },
  notAuthText: { fontSize: 16, color: '#94a3b8', textAlign: 'center', marginBottom: 32, lineHeight: 24 },
  loginButton: { backgroundColor: '#3b82f6', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: 16, borderRadius: 14, gap: 12, width: '100%' },
  loginButtonText: { color: '#ffffff', fontSize: 18, fontWeight: '600' },
  profileCard: { backgroundColor: '#1e293b', borderRadius: 16, padding: 24, alignItems: 'center', marginBottom: 16, borderWidth: 1, borderColor: '#334155' },
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#3b82f6', justifyContent: 'center', alignItems: 'center', marginBottom: 12 },
  profileName: { fontSize: 22, fontWeight: '700', color: '#ffffff', marginBottom: 4 },
  profilePhone: { fontSize: 15, color: '#94a3b8', marginBottom: 4 },
  ...
  statValue: { fontSize: 26, fontWeight: 'bold', color: '#3b82f6', marginTop: 8 },
  statLabel: { fontSize: 13, color: '#94a3b8', marginTop: 4 },
  settingsCard: { backgroundColor: '#1e293b', borderRadius: 14, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#334155' },
  ...
  referralCard: { backgroundColor: '#1e3a5f', borderRadius: 14, padding: 20, marginBottom: 24, borderWidth: 1, borderColor: '#3b82f6' },
  referralHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
  referralTitle: { fontSize: 18, fontWeight: 'bold', color: '#60a5fa' },
  referralText: { fontSize: 14, color: '#93c5fd', marginBottom: 16, lineHeight: 20 },
  referralCodeBox: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#0f172a', padding: 16, borderRadius: 10, marginBottom: 12, borderWidth: 1, borderColor: '#334155' },
  referralCode: { fontSize: 22, fontWeight: 'bold', color: '#3b82f6', letterSpacing: 2 },
  useReferralButton: { alignItems: 'center', padding: 12 },
  useReferralText: { color: '#60a5fa', fontSize: 14, fontWeight: '600' },
  section: { marginBottom: 24 },
  sectionTitle: { fontSize: 18, fontWeight: '700', color: '#ffffff', marginBottom: 16 },
  bookingCard: { backgroundColor: '#1e293b', borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#334155' },
  bookingHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  serviceName: { fontSize: 17, fontWeight: '700', color: '#ffffff', flex: 1 },
  ...
  bookingActions: { flexDirection: 'row', gap: 12, marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: '#e5e7eb', flexWrap: 'wrap' },
  trackingButton: { flexDirection: 'row', alignItems: 'center', gap: 6, padding: 8, borderRadius: 8, backgroundColor: '#eff6ff', borderWidth: 1, borderColor: '#2563eb' },
  trackingButtonText: { color: '#2563eb', fontSize: 14, fontWeight: '600' },
