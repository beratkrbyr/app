...
const styles = StyleSheet.create({
  ...
  notAuthTitle: { fontSize: 24, fontWeight: 'bold', color: '#0f172a', marginTop: 24, marginBottom: 12 },
  notAuthText: { fontSize: 16, color: '#64748b', textAlign: 'center', marginBottom: 32, lineHeight: 24 },
  loginButton: { backgroundColor: '#1e40af', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: 16, borderRadius: 14, gap: 12, width: '100%' },
  loginButtonText: { color: '#ffffff', fontSize: 18, fontWeight: '600' },
  profileCard: { backgroundColor: '#ffffff', borderRadius: 16, padding: 24, alignItems: 'center', marginBottom: 16, borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  profilePhone: { fontSize: 15, color: '#64748b', marginBottom: 4 },
  profileEmail: { fontSize: 14, color: '#94a3b8' },
  statsRow: { flexDirection: 'row', gap: 12, marginBottom: 16 },
  statCard: { flex: 1, backgroundColor: '#ffffff', borderRadius: 14, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: '#e2e8f0' },
  statValue: { fontSize: 26, fontWeight: 'bold', color: '#0f172a', marginTop: 8 },
  statLabel: { fontSize: 13, color: '#64748b', marginTop: 4 },
  settingsCard: { backgroundColor: '#ffffff', borderRadius: 14, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  referralCard: { backgroundColor: '#f0f9ff', borderRadius: 14, padding: 20, marginBottom: 24, borderWidth: 1, borderColor: '#bae6fd' },
  referralHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
  referralTitle: { fontSize: 18, fontWeight: 'bold', color: '#0369a1' },
  referralText: { fontSize: 14, color: '#0284c7', marginBottom: 16, lineHeight: 20 },
  referralCodeBox: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#ffffff', padding: 16, borderRadius: 10, marginBottom: 12, borderWidth: 1, borderColor: '#e0f2fe' },
  referralCode: { fontSize: 22, fontWeight: 'bold', color: '#0369a1', letterSpacing: 2 },
  useReferralButton: { alignItems: 'center', padding: 12 },
  useReferralText: { color: '#0369a1', fontSize: 14, fontWeight: '600' },
  section: { marginBottom: 24 },
  sectionTitle: { fontSize: 18, fontWeight: '700', color: '#0f172a', marginBottom: 16 },
  bookingCard: { backgroundColor: '#ffffff', borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#e2e8f0' },
  bookingHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  serviceName: { fontSize: 17, fontWeight: '700', color: '#0f172a', flex: 1 },
